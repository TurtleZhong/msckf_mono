...
#include <msckf_mono/CameraMeasurement.h>
#include <msckf_mono/TrackingInfo.h>
...
namespace msckf_mono
{
            ...
            const sensor_msgs::ImageConstPtr &cam0_img)
    {
        ...
        // Publish the measurement and tracking info.
        publish();
...
//        best_inlier_set.size(), inlier_markers.size());
    ...
    void ImageProcessor::publish()
    {
        ...
        /*Note: mono */
        tracking_info_msg_ptr->after_matching = after_tracking;
